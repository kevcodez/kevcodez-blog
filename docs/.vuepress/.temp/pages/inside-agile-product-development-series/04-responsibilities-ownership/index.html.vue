<template><div><h1 id="responsibilities-and-ownership" tabindex="-1"><a class="header-anchor" href="#responsibilities-and-ownership" aria-hidden="true">#</a> Responsibilities and ownership</h1>
<p>In the previous post I have explained that the team is fully responsible for developing the product.
...
Also, if the colleague broke the law or did some crazy stuff like purposely deleting the production environment - no need to take the full ownership.</p>
<p>Especially during fuckups, it shows, how the team handles ownership.
...
I will cover some specific fuckups and how we handled them in a later post in more depth.</p>
<p>Taking ownership and being responsible about the product is not just about handling fuckups.
...
If you come across any possible improvements, talk to the team and prioritize.</p>
<p>In our team I've experienced the greatest ownership so far.
...
If your colleague is a normal human with normal emotions, he/she will already feel bad enough for messing up - no need to emphasize.</p>
<p>Many of the features or process improvements were actually suggested by developers, talked through with the business and product owners and then implemented.</p>
<p>For me, having this kind of responsibility and actually making use of it comes with building a bond with the product and team.
...
However, I love what I do and I love being able to have a say in the product development.</p>
<p>If you want the rest of the team to take more ownership, one very important thing is to always explain the <strong>reasoning</strong> behind something.
You have a great suggestion on improving the product and want the team to help you?
Don't just explain your implementation details and what you want to do, explain <strong>why</strong> it improves the product.
It is far easier to have your team back you up, if they understand <strong>why</strong> they're doing it.</p>
<p>Especially in product development, where the team has a lot of freedom, but also responsibility, it is crucial to take full ownership.
...
A good stigma is the <a href="https://en.wikipedia.org/wiki/Pareto_principle" target="_blank" rel="noopener noreferrer">Pareto principle<ExternalLinkIcon/></a>.
You might now it as the <strong>80/20 rule</strong>, meaning you get 80% done in 20% of the time/effort you put in.
...
Do not abuse the freedom that comes with product development, you still need to get shit done.</p>
</div></template>
