<template><div><h1 id="deadlines" tabindex="-1"><a class="header-anchor" href="#deadlines" aria-hidden="true">#</a> Deadlines</h1>
<p>What about deadlines in an agile environment?
While I generally agree that things are done when they are done, deadlines can be great.
However, those deadlines need to be set from <strong>within</strong> the team.
...
<p>Deadlines are not bad, as long as the team sets them.
Let me give you a good and a bad example of deadlines in the past few years.</p>
<p><strong>The Bad</strong></p>
<p>A few years ago, we were developing multiple products.
...
If this happens too often, you should reconsider if Scrum is what you want to do.</p>
<p>We started a sprint, it was pretty packed with tasks.
...
If you do it, you'll likely be unhappy, the sprint goal might be endangered and that project manager will not learn.</p>
<p>In an ideal world, this does not happen in the first place.
...
To be agile, it's not just about your developers, other departments need to adjust, too.</p>
<p><strong>The Good</strong></p>
<p>As we were using Kanban, changing prioritization was as quick as possible.
Any task could have been the next top priority task.
We had a loose roadmap that we followed and looked at regularly.
On some occasions, we set ourselves deadlines which helped us focus and prioritize.</p>
<p>We had been working for a few months on migrating the online shop, product and customer management.
...
This deadline helped us think about what's <strong>necessary</strong> for go-live, what really needs to be done.
...
End of story?
We delivered on time, not a single hour of overtime needed.</p>
<p>We did that a few times.
Every time we set <strong>ourselves</strong> a deadline, focus increased and boosted productivity.</p>
<p>This was a prime example of how deadlines can actually be amazing in an agile team.
